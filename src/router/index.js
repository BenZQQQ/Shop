...
// const MSite = (resolve) => require(['../pages/MSite/MSite.vue'], resolve)
...
export default new VueRouter({
  ...
  routes: [
    {
      path: '/msite',
      component: (resolve) => require(['../pages/MSite/MSite.vue'], resolve), // 返回路由组件的函数, 只有执行此函数才会加载路由组件, 这个函数在请求对应的路由路径时才会执行
      meta: {
        showFooter: true
      }
    },
